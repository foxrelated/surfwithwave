 ...
 * @author  		Raymond Benc
 * @package  		Module_Feed
 * @version 		$Id: feed.class.php 6957 2013-12-02 12:12:10Z Miguel_Espinoza $
 */
...
{	
	...
	*	but it also controls if the entire div should be shown or not, including the dislikes
	...
	public function getPhraseForLikes(&$aFeed, $bForce = false)
	{
	    ...
	    if ( ($iRepCnt = substr_count($sPhrase, 'and')) > 1)
		{
			$sPhrase = preg_replace('/and/', ',', $sPhrase, ($iRepCnt - 1), $iCnt);			
		}
