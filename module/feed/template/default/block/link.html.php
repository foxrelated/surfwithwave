...
<ul id="here">
	...
	<li>
		<a href="{$aFeed.feed_link}add-comment/" class="{if (isset($sFeedType) && $sFeedType == 'mini') || (!isset($aFeed.comment_type_id) && isset($aFeed.total_comment))}{else}js_feed_entry_add_comment no_ajax_link{/if}"><span class="font_icon">&#xf075;</span><!--{phrase var='feed.comment'}--></a>
	</li>				
	...
	{if Phpfox::isModule('report') && isset($aFeed.report_module) && isset($aFeed.force_report)}
		<li><span>&middot;</span></li>	
		<li><a href="#?call=report.add&amp;height=100&amp;width=400&amp;type={$aFeed.report_module}&amp;id={$aFeed.item_id}" class="inlinePopup activity_feed_report" title="{$aFeed.report_phrase}"><span class="font_icon">&#xf069;</span><!--{phrase var='feed.report'}--></a></li>				
	{/if}
	...
	<li><span>&middot;</span></li>
	<li><a href="#" onclick="if (confirm(getPhrase('core.are_you_sure'))){l}$.ajaxCall('feed.delete', 'id={$aFeed.feed_id}{if isset($aFeedCallback.module)}&amp;module={$aFeedCallback.module}&amp;item={$aFeedCallback.item_id}{/if}', 'GET');{r} return false;"><span class="font_icon">&#xf00d;</span></a></li>
	{/if}				
</ul>
<div class="clear"></div>		