...
<?php if (count((array)$this->_aVars['aInvites'])):  $this->_aPhpfoxVars['iteration']['invites'] = 0;  foreach ((array) $this->_aVars['aInvites'] as $this->_aVars['aInvite']):  $this->_aPhpfoxVars['iteration']['invites']++; ?>
	...
	<li><?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aInvite'],'suffix' => '_50_square','max_width' => 32,'max_height' => 32,'class' => 'v_middle')); ?> <?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aInvite']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aInvite']['user_name'], ((empty($this->_aVars['aInvite']['user_name']) && isset($this->_aVars['aInvite']['profile_page_id'])) ? $this->_aVars['aInvite']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getService('user')->getCurrentName($this->_aVars['aInvite']['user_id'], $this->_aVars['aInvite']['full_name']), Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>'; ?></li>
<?php endforeach; endif; ?>
</ul>
<?php endif; ?>
