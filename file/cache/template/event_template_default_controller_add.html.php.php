...
<?php /* Cached: January 31, 2014, 10:31 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
							...
							
{
 ...
 / <?php $aYears = range(2014, 2015);   $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); ?>		<select name="val[start_year]" id="start_year" class="js_datepicker_year">
							...
							
{
 ...
 / <?php $aYears = range(2014, 2015);   $aParams = (isset($aParams) ? $aParams : Phpfox::getLib('phpfox.request')->getArray('val')); ?>		<select name="val[end_year]" id="end_year" class="js_datepicker_year">
