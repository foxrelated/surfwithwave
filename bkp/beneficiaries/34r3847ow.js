...
SmtMenu.sdata =
{
	...
	sites 			: [
	{
							"en-us"	: { code : "en-us", name : "English", host : "www.cloudflare.com", word : "Language", def : true }
		,						"hi-in"	: { code : "hi-in", name : "Hindi", host : "hi.cloudflare.com", word : "Language", def : false }
		,						"fr-fr"	: { code : "fr-fr", name : "Français", host : "fr.cloudflare.com", word : "Langue", def : false }
		,						"sk-sk"	: { code : "sk-sk", name : "Slovak (Slovakia)", host : "sk.cloudflare.com", word : "Language", def : false }
		,						"he-il"	: { code : "he-il", name : "Hebrew", host : "he.cloudflare.com", word : "Language", def : false }
		,						"el-gr"	: { code : "el-gr", name : "Greek", host : "el.cloudflare.com", word : "Language", def : false }
		,						"vi-vn"	: { code : "vi-vn", name : "Vietnamese", host : "vi.cloudflare.com", word : "Language", def : false }
		,						"uk-ua"	: { code : "uk-ua", name : "Українська", host : "ua.cloudflare.com", word : "Language", def : false }
		,						"tr-tr"	: { code : "tr-tr", name : "Turkish (Turkey)", host : "tr.cloudflare.com", word : "Language", def : false }
		,						"da-dk"	: { code : "da-dk", name : "Dansk", host : "da.cloudflare.com", word : "Language", def : false }
		,						"es-es"	: { code : "es-es", name : "Español", host : "es.cloudflare.com", word : "Idioma", def : false }
		,						"no-no"	: { code : "no-no", name : "Norwegian", host : "no.cloudflare.com", word : "Language", def : false }
		,						"fi-fi"	: { code : "fi-fi", name : "Suomi", host : "fi.cloudflare.com", word : "Language", def : false }
		,						"pt-br"	: { code : "pt-br", name : "Português (Brasil)", host : "pt-br.cloudflare.com", word : "Language", def : false }
		,						"ar-eg"	: { code : "ar-eg", name : "Arabic (Egypt)", host : "ar.cloudflare.com", word : "Language", def : false }
		,						"pl-pl"	: { code : "pl-pl", name : "Polski", host : "pl.cloudflare.com", word : "Language", def : false }
		,						"zh-cn"	: { code : "zh-cn", name : "中文", host : "cn.cloudflare.com", word : "Language", def : false }
		,						"hu-hu"	: { code : "hu-hu", name : "Hungarian", host : "hu.cloudflare.com", word : "Language", def : false }
		,						"sr-rs"	: { code : "sr-rs", name : "Serbian", host : "sr.cloudflare.com", word : "Language", def : false }
		,						"pt-pt"	: { code : "pt-pt", name : "Portuguese (Portugal)", host : "pt.cloudflare.com", word : "Language", def : false }
		,						"it-it"	: { code : "it-it", name : "Italiano", host : "it.cloudflare.com", word : "Language", def : false }
		,						"nl-nl"	: { code : "nl-nl", name : "Nederlands", host : "nl.cloudflare.com", word : "Taal", def : false }
		,						"ru-ru"	: { code : "ru-ru", name : "Русский", host : "ru.cloudflare.com", word : "Язык", def : false }
		,						"ko-kr"	: { code : "ko-kr", name : "한국어", host : "ko.cloudflare.com", word : "Language", def : false }
		,						"id-id"	: { code : "id-id", name : "Indonesian", host : "id.cloudflare.com", word : "Language", def : false }
		,						"zh-tw"	: { code : "zh-tw", name : "繁體中文", host : "zh.cloudflare.com", word : "Language", def : false }
		,						"sv-se"	: { code : "sv-se", name : "Svenska", host : "sv.cloudflare.com", word : "Language", def : false }
		,						"cs-cz"	: { code : "cs-cz", name : "Czech", host : "cs.cloudflare.com", word : "Language", def : false }
		,						"ms-my"	: { code : "ms-my", name : "Malay (Malaysia)", host : "ms.cloudflare.com", word : "Language", def : false }
		,						"de-de"	: { code : "de-de", name : "Deutsch", host : "de.cloudflare.com", word : "Language", def : false }
		,						"th-th"	: { code : "th-th", name : "Thai (Thailand)", host : "th.cloudflare.com", word : "Language", def : false }
		,						"ja-jp"	: { code : "ja-jp", name : "日本語", host : "jp.cloudflare.com", word : "Language", def : false }
				}]
};
// END SERVER DATA
