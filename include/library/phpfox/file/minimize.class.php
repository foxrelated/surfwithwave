 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: minimize.class.php 6810 2013-10-21 09:19:50Z Miguel_Espinoza $
 */
    ...
    public function minify($aFiles, $sVersion, $bIsJS = true, $bDoInit = false, $bReturn = false, $bReplaceUrl = true)
    {
        ...
        else
        {
            ...
            else
            {
				...
				$sHomeThemePath = (Phpfox::getParam('core.force_https_secure_pages') ? 'https://' : 'http://') . Phpfox::getParam('core.host') . Phpfox::getParam('core.folder') . 'theme';
